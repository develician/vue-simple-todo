<template>
    <div id="app" class="content">
        ...
        <ul class="todo__list">
            <li v-for="(item, index) in items" class="todo__item" :key='index' :class="{completed:item.completed}">
                ...
                <button type="button" @click="removeItem('item' + index)" class="todo__btn-delete">
